...
function createDeafnessEffect() {
    ...
    function defineAudio(img) {
        $(".Sound").append(`<div class="${img}Channel tooltipsound"> <img src="Images/${img}.png" class="${img}Channel"> <span class="tooltiptextsound">${img}</span> </div>`);
    }
    ...
    $(".tooltipsound>img").click(function() {
        ...
        $(".tooltipsound>img").css("border", "grey solid 0.25rem");
        $(this).css("border", "#41c341 solid 0.25rem");
    });
